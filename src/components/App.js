...
class App extends Component {
  ...
  generateShoppingList = () => {
    return this.props.calendar.reduce((res, { meals })=>{
      const { breakfast, lunch, dinner } = meals;

      breakfast && res.push(breakfast);
      lunch && res.push(lunch);
      dinner && res.push(dinner);

      return res;
    }, [])
    .reduce((ings, { ingredientLines }) => [...ings, ...ingredientLines], [])
  }
